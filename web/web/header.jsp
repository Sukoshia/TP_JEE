...
<header>
    ...
    <%--<c:if test="${not empty Contact.email}">--%>
        <%--<h4><c:out value="Vous etes connecté en tant que : ${Contact.email}"/></h4>--%>
    <%--</c:if>--%>
    ...
    <div id='menu'>
        <nav>
            <ul class="nav-list">
                ...
                <li class="nav-item"><a href="mes annonces">Mes annonces</a></li>
                <li class="nav-item"><a><c:out value="Bienvenue : ${Contact.email}"/></a></li>
            </ul>
        </nav>
    </div>
</header>
